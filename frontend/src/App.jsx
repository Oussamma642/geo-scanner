  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        background:
          "linear-gradient(180deg, #1a1510 0%, #2a1f14 40%, #1e1a12 100%)",
        pointerEvents: "none",
      }}
    >
      {STRATA_LINES.map((_, i) => (
        <div
          ...
          style={{
            ...
            top: `${10 + i * 11}%`,
            height: `${2 + (i % 3)}px`,
            background: `rgba(${180 + i * 8}, ${140 + i * 6}, ${80 + i * 4}, ${
              0.04 + i * 0.01
            })`,
...
const dividerStyle = {
  height: "1px",
  background:
    "linear-gradient(90deg, transparent, rgba(200,170,100,0.2), transparent)",
  margin: "0",
};

export default function App() {
  const [selectedImage, setSelectedImage] = useState(null);
  const [selectedFile, setSelectedFile] = useState(null); // NOUVEAU STATE
...
*/
  ...
  const handleAnalysis = async () => {
    ...
    // Animation esthétique du texte de chargement
    const stepInterval = setInterval(() => {
    ...
    try {
      ...
      // TRÈS IMPORTANT : On transforme l'objet Flask en Tableau pour React
      // {"Basalt": 90, "Clay": 10} => [{class: "Basalt", score: 90}, {class: "Clay", score: 10}]
      const formattedDetails = Object.entries(data.details)
        .map(([className, score]) => ({ class: className, score: score }))
        .sort((a, b) => b.score - a.score); // On trie du plus grand au plus petit
      ...
      clearInterval(stepInterval);
      setIsAnalyzing(false);
      alert("Impossible de joindre le serveur Flask. Est-il bien lancé ?");
    }
  };
        ...
        >
          ...
          <div style={{ paddingTop: "16px" }}>
            ...
            >
              ...
              >
                "La roche est la mémoire de la Terre. Chaque cristal, une page
                d'histoire."
              </p>
            </div>
          </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      height: "16px",
                      borderTop:
                        v === "top" ? `1px solid ${goldAccent}` : "none",
                      borderBottom:
                        v === "bottom" ? `1px solid ${goldAccent}` : "none",
                      borderLeft:
                        h === "left" ? `1px solid ${goldAccent}` : "none",
                      borderRight:
                        h === "right" ? `1px solid ${goldAccent}` : "none",
                    }}
                  />
                );
              }
                ...
                {[...Array(3)].map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      height: "6px",
                      background:
                        i === 0 ? goldAccent : "rgba(200,170,100,0.2)",
                    }}
                  />
                ))}
              </div>
            ...
            <div style={{ padding: "24px" }}>
              ...
              {!selectedImage ? (
                <div
                  ...
                  style={{
                    border: `1px dashed ${
                      isDragging ? goldAccent : "rgba(200,170,100,0.25)"
                    }`,
                    padding: "48px 24px",
                    display: "flex",
                ...
                >
                  ...
                  >
                    Déposer un échantillon
                  </div>
                  <div style={{ ...labelStyle, fontSize: "10px" }}>
                    JPG · PNG — Drag & Drop ou cliquer
                  </div>
                  <input
                    id="file-input"
                    type="file"
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(to top, rgba(20,15,10,0.7) 0%, transparent 50%)",
                      }}
                    />
                    {/* Grid overlay */}
                    <svg
                  ...
                  {!result && (
                    <button
                      ...
                      style={{
                        ...
                        border: `1px solid ${
                          isAnalyzing ? "rgba(200,170,100,0.2)" : goldAccent
                        }`,
                        color: goldAccent,
                      ...
                      {isAnalyzing ? (
                        <>
                          ...
                          <span>
                            {
                              LOADING_STEPS[
                                Math.min(loadingStep, LOADING_STEPS.length - 1)
                              ]
                            }
                          </span>
                        </>
